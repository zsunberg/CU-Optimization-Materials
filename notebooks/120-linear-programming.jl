...
# ╔═╡ 812e3ee8-9d24-11ef-091a-4b1d82533bb5
begin
	using JuMP
	using HiGHS
end

# ╔═╡ cdf0d909-72da-4015-8ff1-4c751f76191d
begin
	model = Model(HiGHS.Optimizer)

	@variable(model, chairs >= 0, Int)
	@variable(model, tables >= 0, Int)
...
# ╔═╡ 344c0354-0055-48cb-b8f4-9ffba35264c5
optimize!(model)

# ╔═╡ 5934f2eb-b46a-4d7c-865f-12effecdc6bb
solution_summary(model; verbose=true)

# ╔═╡ 47bbcec3-e29a-40fb-8595-242ec3e7c4b3
begin
	@info("Result:", objective_value(model), value(chairs), value(tables), dual(wood), dual(labor), dual(space))
end

# ╔═╡ eb0031cb-ebd9-4d33-9f4d-57d5d0ab22b0
...
manifest_format = "2.0"
project_hash = "a0db7179131a102a7106a9d3ba7edcd3622089ba"
